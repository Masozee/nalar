            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex">
                  ...
                  <span className="text-white">Pakarti Centre Building, Jl. Tanah Abang 3 No. 23-27, Jakarta 10160, Indonesia</span>
                </li>
                <li className="flex">
                  <FiPhone className="mt-1 mr-2 flex-shrink-0 text-white" />
                  <span className="text-white">+62 21 386 5532</span>
                </li>
                <li className="flex">
                  <FiMail className="mt-1 mr-2 flex-shrink-0 text-white" />
                  <span className="text-white">csis@csis.or.id</span>
                </li>
              </ul>
            </div>
          </FadeIn>
