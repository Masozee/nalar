        ...
        <section className="sticky top-16 z-40 bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="flex overflow-x-auto py-4 gap-8">
              ...
              <Link href="/about/board-of-directors" className="text-accent font-bold whitespace-nowrap border-b-2 border-accent px-1 py-2">
                Board of Directors
              </Link>
              ...
              {executives.map((executive, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-accent font-medium mb-4">{executive.position}</p>
                    <p className="text-gray-600 mb-6">{executive.organization}</p>
                    {executive.profile_url && (
                      <div className="flex items-center space-x-4">
                        <a 
                          href={executive.profile_url} 
                          target="_blank" 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Our executives drive CSIS Indonesia's day-to-day operations, lead research initiatives, and implement strategic goals to advance Indonesian policy research and dialogue.
              </p>
              <Link 
